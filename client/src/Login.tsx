...
export default function Login() {
  ...
  return (
    <div className="container flex justify-center items-center p-10 h-screen bg-gradient-to-br from-blue-500 to-blue-800 dark:from-slate-900 dark:to-slate-900">
